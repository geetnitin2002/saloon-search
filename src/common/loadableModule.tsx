...
export const homeModule = loaderWrapper(() =>
  import(/*webpackChunkName: "home"*/ "../common/modules/home")
);
...
export const businessSearchModule = loaderWrapper(() =>
  import(
    /*webpackChunkName: "home"*/ "./modules/home/businessPanel/servicesAndBusiness"
  )
);
